            ...
            steps{
                script{
                    dir('kubernetes/') {
                        ...
                        sh 'microk8s helm install -n datree datree-webhook datree-webhook/datree-admission-webhook --debug \ --create-namespace \ --set datree.token=GJdx2cP2TCDyUY3EhQKgTc \ --set datree.clusterName=$(microk8s kubectl config current-context)'
